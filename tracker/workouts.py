...
five_day = {
    "Back": [
        ...
        {"Hammer Strength Machine Row": "4 sets of 10 reps"},
        {"One Arm Cable Row": "3 sets of 12 reps"},
        {"Straight Arm Cable Pull Down": "2 sets of 15 reps"}
    ],
    "Chest & Abs": [
        {
            "Chest": [
    ...
    "Shoulders & Abs": [
        {
            "Shoulders": [
                ...
                {"Lateral Raise": "4 sets of 8-12 reps"},
                {"Reverse Machine Fly": "4 sets of 8-12 reps"},
                {"Machine Shoulder Press": "3 sets of 6-10 reps"},
                {"Barbell Shrugs": "4 sets of 15 reps"}
            ]
        },
        {
            "Abs": [
                {"Decline Sit Up": "3 sets of 15 reps"},
                {"Barbell Roll Out": "3 sets of 12 reps"}
            ]
        }
    ],
    "Arms": [
        ...
        {
            "Triceps": [
                {"EZ Bar Skullcrusher": "4 sets of 8-12 reps"},
                {"Tricep Dip": "4 sets of 8-12 reps"},
                {"Cable Overhead Tricep Extension": "4 sets of 8-12 reps"}
            ]
        }
    ]
}
